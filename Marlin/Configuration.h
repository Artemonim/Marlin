...
#elif NEPTUNE_3_MAX
  #define DEFAULT_AXIS_STEPS_PER_UNIT   {80.20, 80.20, 400.00, 409.77}
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 150, 20, 40 }
...
// (4 with stock Neptune 3 Display)
//
